...
<%@include file="testTreeDialogList.js"%>
</head>
<body>
	...
	<div class="wrapper wrapper-content">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
						...
						<div class="pull-left treetable-bar">
							<shiro:hasPermission name="test:tree:testTreeDialog:add">
								<a id="add" class="btn btn-primary"
									onclick="jp.openDialog('新建机构', '${ctx}/test/tree/testTreeDialog/form','800px', '500px', $testTreeDialogTreeTable)"><i
				...
				<table id="testTreeDialogTreeTable" class="table table-hover">
					<thead>
						<tr>
							<th>名称</th>
							<th>备注信息</th>
					...
					<tbody id="testTreeDialogTreeTableList"></tbody>
				</table>
				<br />
			</div>
		</div>
