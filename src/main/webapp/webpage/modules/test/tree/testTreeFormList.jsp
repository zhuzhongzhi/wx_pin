...
<%@include file="testTreeFormList.js"%>
</head>
<body>
	...
	<div class="wrapper wrapper-content">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
						...
						<div class="pull-left treetable-bar">
							<shiro:hasPermission name="test:tree:testTreeForm:add">
								<a id="add" class="btn btn-primary"
									href="${ctx}/test/tree/testTreeForm/form" title="机构"><i
				...
				<table id="testTreeFormTreeTable" class="table table-hover">
					<thead>
						<tr>
							<th>名称</th>
							<th>备注信息</th>
					...
					<tbody id="testTreeFormTreeTableList"></tbody>
				</table>
				<br />
			</div>
		</div>
