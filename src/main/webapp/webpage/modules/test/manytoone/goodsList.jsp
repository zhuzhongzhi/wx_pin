					...
					<div id="collapseTwo" class="accordion-body collapse">
						<div class="accordion-inner">
							<form:form id="searchForm" modelAttribute="goods"
								...
								<div class="col-xs-12 col-sm-6 col-md-4">
									<label class="label-item single-overflow pull-left"
										title="所属类型：">所属类型：</label>
									<sys:treeselect id="category" name="category.id"
										value="${goods.category.id}" labelName="category.name"
										labelValue="${goods.category.name}" title="所属类型"
										url="/test/manytoone/category/treeData" extId="${goods.id}"
				...
				<div id="toolbar">
					...
					<shiro:hasPermission name="test:manytoone:goods:import">
						...
						<div id="importBox" class="hide">
							<form id="importForm" action="${ctx}/test/manytoone/goods/import"
