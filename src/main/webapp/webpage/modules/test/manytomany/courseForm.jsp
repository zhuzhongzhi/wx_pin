				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">
							<a class="panelButton" href="${ctx}/test/manytomany/course"><i
								class="ti-angle-left"></i> 返回</a>
						</h3>
					</div>
					<div class="panel-body">
						<form:form id="inputForm" modelAttribute="course"
							action="${ctx}/test/manytomany/course/save" method="post"
							...
							<c:if
								test="${fns:hasPermission('test:manytomany:course:edit') || isAdd}">
