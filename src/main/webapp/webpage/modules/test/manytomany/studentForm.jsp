				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">
							<a class="panelButton" href="${ctx}/test/manytomany/student"><i
								class="ti-angle-left"></i> 返回</a>
						</h3>
					</div>
					<div class="panel-body">
						<form:form id="inputForm" modelAttribute="student"
							action="${ctx}/test/manytomany/student/save" method="post"
							...
							<c:if
								test="${fns:hasPermission('test:manytomany:student:edit') || isAdd}">
