	...
	<div class="wrapper wrapper-content">
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				...
				<div class="accordion-group">
					<div id="collapseTwo" class="accordion-body collapse">
						<div class="accordion-inner">
							<form:form id="searchForm" modelAttribute="testDataMainDialog"
								class="form form-horizontal well clearfix">
								<div class="col-xs-12 col-sm-6 col-md-4">
									<label class="label-item single-overflow pull-left"
										title="归属用户：">归属用户：</label>
									<sys:userselect id="tuser" name="tuser.id"
										value="${testDataMainDialog.tuser.id}" labelName="tuser.name"
								...
								<div class="col-xs-12 col-sm-6 col-md-4">
									<div class="form-group">
										<label class="label-item single-overflow pull-left"
											title="性别：">&nbsp;性别：</label>
										<div class="col-xs-12">
											<form:radiobuttons class="i-checks" path="sex"
								...
								<div class="col-xs-12 col-sm-6 col-md-4">
									<div class="form-group">
										<label class="label-item single-overflow pull-left"
											title="加入日期：">&nbsp;加入日期：</label>
										<div class="col-xs-12">
											<div class="col-xs-12 col-sm-5">
												<div class='input-group date' id='beginInDate'
													style="left: -10px;">
											...
											<div class="col-xs-12 col-sm-5">
												<div class='input-group date' id='endInDate'
													style="left: -10px;">
				...
				<div id="toolbar">
					<shiro:hasPermission
						name="test:onetomanydialog:testDataMainDialog:add">
						<a id="add" class="btn btn-primary" onclick="add()"><i
							class="glyphicon glyphicon-plus"></i> 新建</a>
					</shiro:hasPermission>
					<shiro:hasPermission
						name="test:onetomanydialog:testDataMainDialog:edit">
					...
					<shiro:hasPermission
						name="test:onetomanydialog:testDataMainDialog:del">
					...
					<shiro:hasPermission
						name="test:onetomanydialog:testDataMainDialog:import">
						<button id="btnImport" class="btn btn-info">
							<i class="fa fa-folder-open-o"></i> 导入
						</button>
						<div id="importBox" class="hide">
							<form id="importForm"
								action="${ctx}/test/onetomanydialog/testDataMainDialog/import"
