...
<body class="bg-white">
	<form:form id="inputForm" modelAttribute="testDataMainDialog"
		action="${ctx}/test/onetomanydialog/testDataMainDialog/save"
			...
			<tbody>
				<tr>
					<td class="width-15 active"><label class="pull-right"><font
							color="red">*</font>归属用户：</label></td>
					<td class="width-35"><sys:userselect id="tuser"
							name="tuser.id" value="${testDataMainDialog.tuser.id}"
							labelName="tuser.name"
							labelValue="${testDataMainDialog.tuser.name}"
							cssClass="form-control required" /></td>
					<td class="width-15 active"><label class="pull-right"><font
							color="red">*</font>归属部门：</label></td>
					<td class="width-35"><sys:treeselect id="office"
							name="office.id" value="${testDataMainDialog.office.id}"
							labelName="office.name"
							labelValue="${testDataMainDialog.office.name}" title="部门"
				...
				<tr>
					<td class="width-15 active"><label class="pull-right"><font
							color="red">*</font>归属区域：</label></td>
					<td class="width-35"><sys:treeselect id="area" name="area.id"
							value="${testDataMainDialog.area.id}" labelName="area.name"
							labelValue="${testDataMainDialog.area.name}" title="区域"
				...
				<tr>
					<td class="width-15 active"><label class="pull-right"><font
							color="red">*</font>性别：</label></td>
					<td class="width-35"><form:radiobuttons path="sex"
							items="${fns:getDictList('sex')}" itemLabel="label"
							itemValue="value" htmlEscape="false" class="i-checks required" />
					</td>
					<td class="width-15 active"><label class="pull-right"><font
							color="red">*</font>加入日期：</label></td>
					<td class="width-35">
						<p class="input-group">
						<div class='input-group form_datetime' id='inDate'>
							<input type='text' name="inDate" class="form-control required"
								value="<fmt:formatDate value="${testDataMainDialog.inDate}" pattern="yyyy-MM-dd HH:mm:ss"/>" />
		...
		<div class="tabs-container">
			<ul class="nav nav-tabs">
				<li class="active"><a data-toggle="tab" href="#tab-1"
					aria-expanded="true">火车票：</a></li>
				<li class=""><a data-toggle="tab" href="#tab-2"
					aria-expanded="false">飞机票：</a></li>
				<li class=""><a data-toggle="tab" href="#tab-3"
					aria-expanded="false">汽车票：</a></li>
			</ul>
			<div class="tab-content">
				<div id="tab-1" class="tab-pane fade in  active">
					<a class="btn btn-white btn-sm"
						onclick="addRow('#testDataChild11List', testDataChild11RowIdx, testDataChild11Tpl);testDataChild11RowIdx = testDataChild11RowIdx + 1;"
				...
				<div id="tab-2" class="tab-pane fade">
					<a class="btn btn-white btn-sm"
						onclick="addRow('#testDataChild22List', testDataChild22RowIdx, testDataChild22Tpl);testDataChild22RowIdx = testDataChild22RowIdx + 1;"
						title="新增"><i class="fa fa-plus"></i> 新增</a>
					<table class="table table-striped table-bordered table-condensed">
						<thead>
							<tr>
				...
				<div id="tab-3" class="tab-pane fade">
					<a class="btn btn-white btn-sm"
						onclick="addRow('#testDataChild33List', testDataChild33RowIdx, testDataChild33Tpl);testDataChild33RowIdx = testDataChild33RowIdx + 1;"
						title="新增"><i class="fa fa-plus"></i> 新增</a>
					<table class="table table-striped table-bordered table-condensed">
						<thead>
							<tr>
