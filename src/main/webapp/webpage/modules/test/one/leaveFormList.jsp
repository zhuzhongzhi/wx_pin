				...
				<div class="accordion-group">
					<div id="collapseTwo" class="accordion-body collapse">
						<div class="accordion-inner">
							<form:form id="searchForm" modelAttribute="leaveForm"
								class="form form-horizontal well clearfix">
								<div class="col-xs-12 col-sm-6 col-md-4">
									<label class="label-item single-overflow pull-left"
										title="归属部门：">归属部门：</label>
									<sys:treeselect id="office" name="office.id"
										value="${leaveForm.office.id}" labelName="office.name"
										labelValue="${leaveForm.office.name}" title="部门"
								...
								<div class="col-xs-12 col-sm-6 col-md-4">
									...
									<sys:userselect id="tuser" name="tuser.id"
										value="${leaveForm.tuser.id}" labelName="tuser.name"
										labelValue="${leaveForm.tuser.name}"
										cssClass="form-control required" />
								</div>
								<div class="col-xs-12 col-sm-6 col-md-4">
									<label class="label-item single-overflow pull-left"
										title="归属区域：">归属区域：</label>
									<div class=" input-group" style="width: 100%;">
										<form:input path="area" htmlEscape="false"
								...
								<div class="col-xs-12 col-sm-6 col-md-4">
									<div class="form-group">
										<label class="label-item single-overflow pull-left"
											title="请假开始日期：">&nbsp;请假开始日期：</label>
										<div class="col-xs-12">
											<div class="col-xs-12 col-sm-5">
												<div class='input-group date' id='beginBeginDate'
													style="left: -10px;">
													<input type='text' name="beginBeginDate"
											...
											<div class="col-xs-12 col-sm-5">
												<div class='input-group date' id='endBeginDate'
													style="left: -10px;">
								...
								<div class="col-xs-12 col-sm-6 col-md-4">
									<label class="label-item single-overflow pull-left"
										title="备注信息：">备注信息：</label>
									<form:input path="remarks" htmlEscape="false" maxlength="257"
										class=" form-control" />
								</div>
								<div class="col-xs-12 col-sm-6 col-md-4">
				...
				<div id="toolbar">
					<shiro:hasPermission name="test:one:leaveForm:add">
						<a id="add" class="btn btn-primary"
							href="${ctx}/test/one/leaveForm/form" title="请假表单"><i
					...
					<shiro:hasPermission name="test:one:leaveForm:import">
						...
						<div id="importBox" class="hide">
							<form id="importForm" action="${ctx}/test/one/leaveForm/import"
