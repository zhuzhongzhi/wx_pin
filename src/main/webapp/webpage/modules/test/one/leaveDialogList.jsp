				...
				<div class="accordion-group">
					<div id="collapseTwo" class="accordion-body collapse">
						<div class="accordion-inner">
							<form:form id="searchForm" modelAttribute="leaveDialog"
								...
								<div class="col-xs-12 col-sm-6 col-md-4">
									...
									<sys:treeselect id="office" name="office.id"
										value="${leaveDialog.office.id}" labelName="office.name"
										labelValue="${leaveDialog.office.name}" title="部门"
								...
								<div class="col-xs-12 col-sm-6 col-md-4">
									...
									<sys:userselect id="tuser" name="tuser.id"
										value="${leaveDialog.tuser.id}" labelName="tuser.name"
										labelValue="${leaveDialog.tuser.name}"
				...
				<div id="toolbar">
					...
					<shiro:hasPermission name="test:one:leaveDialog:import">
						...
						<div id="importBox" class="hide">
							<form id="importForm" action="${ctx}/test/one/leaveDialog/import"
