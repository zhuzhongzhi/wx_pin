						...
						<div class="accordion-inner">
							<form:form id="searchForm" modelAttribute="testValidation"
								...
								<div class="col-xs-12 col-sm-6 col-md-4">
									...
									<form:input path="num2" htmlEscape="false"
										class=" form-control" />
								</div>
								<div class="col-xs-12 col-sm-6 col-md-4">
				...
				<div id="toolbar">
					<shiro:hasPermission name="test:validation:testValidation:add">
						<a id="add" class="btn btn-primary"
							href="${ctx}/test/validation/testValidation/form" title="测试校验"><i
					...
					<shiro:hasPermission name="test:validation:testValidation:import">
						...
						<div id="importBox" class="hide">
							<form id="importForm"
								action="${ctx}/test/validation/testValidation/import"
