				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">
							<a class="panelButton"
								href="${ctx}/test/validation/testValidation"><i
								class="ti-angle-left"></i> 返回</a>
						</h3>
					</div>
					<div class="panel-body">
						<form:form id="inputForm" modelAttribute="testValidation"
							action="${ctx}/test/validation/testValidation/save" method="post"
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<form:input path="num" htmlEscape="false" max="69.3" min="20.1"
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<form:input path="num2" htmlEscape="false" max="30" min="10"
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<form:input path="str" htmlEscape="false" maxlength="65"
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<form:input path="email" htmlEscape="false" maxlength="60"
										minlength="10" class="form-control required email" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label"><font color="red">*</font>网址：</label>
								<div class="col-sm-10">
									<form:input path="url" htmlEscape="false" maxlength="30"
										minlength="10" class="form-control required url" />
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<form:input path="c1" htmlEscape="false"
										class="form-control required isFloatLteZero" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label"><font color="red">*</font>身份证号码：</label>
								<div class="col-sm-10">
									<form:input path="c2" htmlEscape="false"
										class="form-control required isIdCardNo" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label"><font color="red">*</font>QQ号码：</label>
								<div class="col-sm-10">
									<form:input path="c3" htmlEscape="false"
										class="form-control required isQq" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label"><font color="red">*</font>手机号码：</label>
								<div class="col-sm-10">
									<form:input path="c4" htmlEscape="false"
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<form:input path="c5" htmlEscape="false"
										class="form-control required stringCheck" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label"><font color="red">*</font>合法字符(a-z
									A-Z 0-9)：</label>
								<div class="col-sm-10">
									<form:input path="c6" htmlEscape="false"
										class="form-control required isRightfulString" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label">英语：</label>
								<div class="col-sm-10">
									<form:input path="en" htmlEscape="false"
										class="form-control  isEnglish" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label">汉子：</label>
								<div class="col-sm-10">
									<form:input path="zn" htmlEscape="false"
										class="form-control  isChinese" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label">汉英字符：</label>
								<div class="col-sm-10">
									<form:input path="enzn" htmlEscape="false"
										class="form-control  isChineseChar" />
								</div>
							</div>
							<c:if
								test="${fns:hasPermission('test:validation:testValidation:edit') || isAdd}">
