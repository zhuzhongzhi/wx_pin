		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control required" name="title"
					id="title" placeholder="记录你将要做的一件事..." value="${myCalendar.title}">
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-10">
				...
				<div class='input-group form_datetime' id='start'>
					<input type='text' name="start" class="form-control required"
						value="<fmt:formatDate value="${myCalendar.start}" pattern="yyyy-MM-dd HH:mm:ss"/>" />
			...
			<div class="col-sm-10">
				...
				<div class='input-group form_datetime' id='end'>
					<input type='text' name="end" class="form-control required"
						value="<fmt:formatDate value="${myCalendar.end}" pattern="yyyy-MM-dd HH:mm:ss"/>" />
					<span class="input-group-addon"> <span
						class="glyphicon glyphicon-calendar"></span>
					</span>
				</div>
