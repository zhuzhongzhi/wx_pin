		...
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<form:form id="searchForm" modelAttribute="user"
					action="${ctx}/iim/contact/index" method="post" class="input-group">
											...
											<c:forEach items="${list}" var="user">
												<tr>
													<td class="client-avatar"><img alt="image"
														...
														src="<c:if test="${user.photo == null || user.photo==''}">${ctxStatic}/common/images/flat-avatar.png</c:if> <c:if test="${user.photo != null && user.photo!=''}">${user.photo}</c:if>">
													</td>
													...
													<td class="contact-type"><a
														...
														class="btn btn-info btn-xs"><i class="fa fa-envelope">
																站内信</i></a></td>
