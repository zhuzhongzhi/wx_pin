				...
				<div id="toolbar">
					<shiro:hasPermission name="monitor:scheduleJob:add">
						<a id="add" class="btn btn-primary"
							href="${ctx}/monitor/scheduleJob/form" title="定时任务"><i
