				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">
							<a class="panelButton" href="${ctx}/monitor/scheduleJob"><i
								class="ti-angle-left"></i> 返回</a>
						</h3>
					</div>
					<div class="panel-body">
						<form:form id="inputForm" modelAttribute="scheduleJob"
							action="${ctx}/monitor/scheduleJob/save" method="post"
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<form:select path="group" class="form-control required">
										...
										<form:options
											items="${fns:getDictList('schedule_task_group')}"
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<form:input path="cronExpression" htmlEscape="false"
										class="form-control required isCronExpress" />
									<div style="margin-top: 10px;"
										class="alert alert-info alert-dismissable">
										<strong>Cron示例：</strong>前后不要有空格<br> &nbsp;*/5 * * * * ?
										每隔5秒执行<br> &nbsp;0 */1 * * * ? 每隔1分钟执行<br> &nbsp;0 0
										23 * * ? 每天23点执行<br>
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<form:select path="isInfo" class="form-control ">
										<form:option value="" label="" />
										<form:options items="${fns:getDictList('schedule_task_info')}"
											itemLabel="label" itemValue="value" htmlEscape="false" />
									</form:select>
								</div>
							</div>
