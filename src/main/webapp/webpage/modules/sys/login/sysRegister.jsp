		...
		<div class="row">
			<div class="col-md-4 col-lg-4 col-md-offset-4 col-lg-offset-4">
				<img class="img-circle"
					src="${ctxStatic}/common/images/flat-avatar.png"
					class="user-avatar" />
				<h1>Jeeplus</h1>
				...
				<form:form id="inputForm" modelAttribute="user"
					...
					<input type="hidden" value="wangba" name="roleName">
					<!-- 默认注册用户都是网吧管理员 -->
					<div class="form-content">
						<div class="form-group">
							<input id="tel" name="mobile" type="text" value="" maxlength="11"
								minlength="11"
								class="form-control input-underline input-lg required isMobile"
								placeholder="手机号" />
						</div>

						<div class=" form-group">
							<div class="col-sm-9">
								<input id="code" name="randomCode" type="text" value=""
						...
						<div class="form-group">
							<input id="userId" name="loginName" type="text"
						...
						<div class="form-group">
							<input id="confirmNewPassword" name="confirmNewPassword"
								...
								class="form-control input-underline input-lg required"
								equalTo="#newPassword" placeholder="重复密码" />
						</div>
						<div class="form-group">

							<label class="block"> <input name="ck1" type="checkbox" />
								<span class="lbl"> 我接受 <a href="#"><font
										color="white">《JeePlus用户注册协议》</font></a>
							</span> <label id="ck1-error" class="error" for="ck1"
								style="display: none;">必须接受用户协议</label>
							</label>
							<ul class="pull-right btn btn-info btn-circle"
								style="background-color: white; height: 45px; width: 46px">
						...
						<input type="reset"
							...
							value="重置"> &nbsp; <input type="submit"
							class="btn btn-white btn-outline btn-lg btn-rounded progress-login"
							value="注册">
					</div>
				</form:form>
				<div class="form-options center">
					<a href="${ctx }/login" data-target="#login-box" class=""> <font
