									...
									<form id="searchForm"
										...
										<div class="col-xs-12 col-sm-6 col-md-4">
											<label class="label-item single-overflow pull-left"
												title="类型：">类型：</label> <input id="type" name="type"
												class="form-control m-b" />
										</div>
										<div class="col-xs-12 col-sm-6 col-md-4">
											<label class="label-item single-overflow pull-left"
												title="描述">描述：</label> <input id="description"
					...
					<div id="right" class="panel panel-default col-sm-6"
						...
						<div class="panel-heading">
							<h3 class="panel-title">
								<label>键值列表，所属类型: </label><font id="dictTypeLabel"></font><input
									type="hidden" id="dictTypeId" />
							</h3>
						</div>
						<div class="panel-body">
							<div id="dictValueToolbar">
								<button id="dictValueButton" class="btn btn-outline btn-primary"
									title="添加键值">
