		...
		<div class="col-md-12">
			<div class="panel panel-primary">
				<div class="panel-body">
					<form:form id="inputForm" modelAttribute="dataRule"
						action="${ctx}/sys/dataRule/save" method="post"
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<form:input path="field" htmlEscape="false"
									class="form-control " />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<form:select path="express" class="form-control ">
									...
									<form:options items="${fns:getDictList('t_express')}"
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<form:textarea path="sqlSegment" htmlEscape="false" rows="4"
									class="form-control " />
							</div>
						</div>
						<div class="form-group">
