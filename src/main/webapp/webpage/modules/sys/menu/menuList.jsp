						...
						<div id="toolbar" class="treetable-bar">
							<shiro:hasPermission name="sys:menu:add">
								<a id="add" class="btn btn-primary"
									onclick="jp.openDialog('新建菜单', '${ctx}/sys/menu/form','800px', '500px', $treeTable)"><i
					...
					<div id="right" class="panel panel-default col-sm-6"
						...
						<div class="panel-heading">
							<h3 class="panel-title">
								<label>数据规则列表，所属菜单: </label><font id="menuLabel"></font><input
									type="hidden" id="menuId" />
							</h3>
						</div>
						<div class="panel-body">
							<div id="dataRuleToolbar">
								<button id="dataRuleAddButton"
									class="btn btn-outline btn-primary" title="添加规则">
									<i class="fa fa-plus"></i> 添加规则
								</button>
							</div>
							<!-- 表格 -->
							<table id="dataRuleTable" data-toolbar="#dataRuleToolbar"
								data-id-field="id">
							</table>
						</div>
					</div>
