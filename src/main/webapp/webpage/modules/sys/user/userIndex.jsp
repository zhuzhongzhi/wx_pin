...
<link href="${ctxStatic}/plugin/bootstrapTree/bootstrap-treeview.css"
	rel="stylesheet" type="text/css" />
<script src="${ctxStatic}/plugin/bootstrapTree/bootstrap-treeview.js"
									...
									<form id="searchForm"
										...
										<div class="col-xs-12 col-sm-6 col-md-4">
											<label class="label-item single-overflow pull-left"
												title="公司：">归属公司：</label>
											<sys:treeselect id="company" name="company.id" title="公司"
										...
										<div class="col-xs-12 col-sm-6 col-md-4">
											<label class="label-item single-overflow pull-left"
												title="员工：">归属部门：</label>
											<sys:treeselect id="office" name="office.id" title="部门"
												url="/sys/office/treeData?type=2" cssClass=" form-control"
												allowClear="true" notAllowSelectParent="true" />
										</div>
										<div class="col-xs-12 col-sm-6 col-md-4">
											<label class="label-item single-overflow pull-left"
												title="登录名：">登录名：</label> <input type="text"
												name="loginName" maxlength="100" class=" form-control" />
										</div>
										<div class="col-xs-12 col-sm-6 col-md-4">
											<label class="label-item single-overflow pull-left"
												title="姓名：">姓名：</label> <input type="text" name="name"
						...
						<div id="toolbar">
							...
							<shiro:hasPermission name="sys:user:import">
								...
								<div id="importBox" class="hide">
									<form id="importForm" action="${ctx}/sys/user/import"
							...
							<shiro:hasPermission name="sys:user:export">
								<a id="export" class="btn btn-warning"
									href="${ctx}/sys/user/export"><i class="fa fa-file-excel-o"></i>
									导出</a>
							</shiro:hasPermission>
