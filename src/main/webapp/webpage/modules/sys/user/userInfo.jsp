		...
		<div class="row">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">
							个人资料 <a id="userImageBtn" title="更换头像"
								class="panelButton pull-right"><i class="fa fa-user"> </i> </a>
							<a id="userInfoBtn" title="编辑资料" class="panelButton pull-right"><i
			...
			<div class="col-md-6">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">
							登录信息 <a id="userPassWordBtn" title="修改密码"
								class="panelButton pull-right"><i class="fa fa-venus"></i>更换密码</a>
						</h3>
					</div>
					<div class="panel-body">
						<div class="row">
