		...
		<table class="table table-bordered">
			<tbody>
				<tr>
					...
					<td class="width-35"><sys:treeselect id="company"
				...
				<tr>
					...
					<td><sys:treeselect id="office" name="office.id"
							...
							labelValue="${user.office.name}" allowClear="true" title="部门"
				...
				<tr>
					...
					<td><form:checkboxes path="roleIdList" items="${allRoles}"
							itemLabel="name" itemValue="id" htmlEscape="false"
							cssClass="i-checks required" /> <label id="roleIdList-error"
						class="error" for="roleIdList"></label></td>
