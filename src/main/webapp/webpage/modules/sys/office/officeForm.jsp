			...
			<tbody>
				<tr>
					...
					<td class="width-35"><sys:treeselect id="office"
							...
							cssClass="form-control" allowClear="true" /></td>
					<td class="width-15" class="active"><label class="pull-right"><font
					...
					<td class="width-35"><sys:treeselect id="area" name="area.id"
							...
							labelValue="${office.area.name}" title="区域" allowClear="true"
							url="/sys/area/treeData" cssClass="form-control required" /></td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right"><font
							color="red">*</font>机构名称:</label></td>
					...
					<td class="width-35"><form:input path="code"
							htmlEscape="false" maxlength="50" class="form-control" /></td>
				</tr>
				<tr>
					...
					<td class="width-35"><form:select path="grade"
							class="form-control">
				...
				<tr>
					...
					<td class="width-35"><form:input path="fax" htmlEscape="false"
