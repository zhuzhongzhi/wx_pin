			...
			<div class="panel-body">
							...
							<form id="searchForm" class="form form-horizontal well clearfix">
								<div class="col-xs-12 col-sm-6 col-md-4">
									<label class="label-item single-overflow pull-left"
										title="操作菜单：">操作菜单：</label> <input id="title" name="title"
										type="text" maxlength="50" class="form-control" />
								</div>
								<div class="col-xs-12 col-sm-6 col-md-4">
									<label class="label-item single-overflow pull-left"
										title="用户id：">操作用户：</label> <input id="createBy.name"
										name="createBy.name" type="text" maxlength="50"
										class="form-control" />
								</div>
								<div class="col-xs-12 col-sm-6 col-md-4">
									<label class="label-item single-overflow pull-left"
										title="URI：">URI：</label> <input id="requestUri"
										name="requestUri" type="text" maxlength="50"
										class="form-control" />
								</div>
								<div class="col-xs-12 col-sm-6 col-md-4">
									<label class="label-item single-overflow pull-left"
										title="日期范围：">日期范围：</label>
									<div class="col-xs-12">
								...
								<div class="col-xs-12 col-sm-6 col-md-4">
									<div class="form-group">
										<label class="label-item single-overflow pull-left"
											title="只查询异常信息：">只查询异常信息：</label>
										<div class="col-xs-12">
											<input id="exception" name="exception"
												class="i-checks form-control" type="checkbox" value="1" />
										</div>
									</div>
								</div>
				...
				<div id="toolbar">
					<shiro:hasPermission name="sys:log:del">
						...
						<button class="accordion-toggle btn btn-danger" onclick="empty()"
							title="清空">
