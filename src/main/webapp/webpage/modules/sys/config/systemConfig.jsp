		...
		<div class="row animated fadeInRight">
					...
					<div class="panel panel-primary">
						<div class="panel-heading">
							...
							<div class="pull-right">
								<a href="#" onclick="modifyMail()" style="color: white"> <i
									style="font-size: 20px" class="fa  fa-save"></i>
								</a>
							</div>
						</div>
			...
			<div class="col-sm-5">
				<form:form id="inputForm1" modelAttribute="systemConfig"
					...
					<div class="panel panel-primary">
						<div class="panel-heading">
							<i class="fa fa-comment"></i> 短信设置(<a href="http://www.cnsms.cn/"
								target="_blank"><font color="white">企信通</font></a>)
							<div class="pull-right">
								<a href="#" onclick="modifySms()" style="color: white"> <i
									style="font-size: 20px" class="fa  fa-save"></i>
								</a>
							</div>
						</div>
