			...
			<div class="panel-body">
				<form:form id="inputForm" modelAttribute="sysDataSource"
					...
					<div class="row">
						...
						<div class="col-sm-2">
							...
							<button type="button" class="btn btn-primary  btn-sm"
								onclick="queryByColumn()">
								<i class="fa fa-reply"></i> 生成sql
							</button>
						</div>
					</div>
					<br>
					<div class="row ">
						...
						<div class="col-sm-7">
							<textarea id="sql" name="sql" class="form-control" required=""
