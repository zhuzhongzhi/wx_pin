...
<body>
				...
				<div class="col-sm-12">
					...
					<form method="get" class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="hidden" name="S_TYPE" id="S_TYPE"
									value="${testInterface.type eq 'post'?'POST':'GET'}" /> <input
									name="form-field-radio" class="form-control i-checks"
									type="radio" value="POST"
									<c:if test="${testInterface.type eq 'post'}">checked="checked"</c:if>>POST
								<input name="form-field-radio" class="form-control i-checks"
									type="radio" value="GET"
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" id="serverUrl" title="输入请求地址"
									value="${testInterface.url }" class="form-control"> <span><font
									color="gray">如果URL包括JSESSIONID字段，请先调用登录接口，把生成的JSESSIONID参数替换此处的值，否则会提示没有登录。</font></span>
							</div>
							<div class="col-sm-2">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" id="requestBody" title="输入请求地址"
									value="${testInterface.body }" class="form-control"> <span><font
									color="gray">格式: name1=value1&name2=value2, 如果是get请求请留空。</font></span>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<textarea id="json-field" title="返回结果"
									class="form-control span12"></textarea>
							</div>
							<div class="col-sm-2"></div>
						</div>
						<div class="hr-line-dashed"></div>
	...
	<script type="text/javascript"
		src="${ctxStatic }/common/js/interfaceTest.js"></script>
</body>
</html>
