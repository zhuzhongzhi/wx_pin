				...
				<div id="toolbar">
					<shiro:hasPermission name="tools:testInterface:add">
						<a id="add" class="btn btn-primary"
							href="${ctx}/tools/testInterface/form"><i
					...
					<button class="btn btn-info " onclick="test()">
						<i class="fa fa-check"></i> 测试
					</button>
