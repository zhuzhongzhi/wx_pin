				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">
							<a class="panelButton" href="${ctx}/tools/testInterface"><i
								class="ti-angle-left"></i> 返回</a>
						</h3>
					</div>
					<div class="panel-body">
						<form:form id="inputForm" modelAttribute="testInterface"
							action="${ctx}/tools/testInterface/save" method="post"
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<form:input path="name" htmlEscape="false" maxlength="1024"
										class="form-control " />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<form:select path="type" class="form-control ">
										...
										<form:options items="${fns:getDictList('interface_type')}"
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<form:input path="url" htmlEscape="false" maxlength="256"
										class="form-control " />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<form:input path="body" htmlEscape="false" maxlength="2048"
										class="form-control " />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<form:input path="successmsg" htmlEscape="false"
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<form:input path="errormsg" htmlEscape="false" maxlength="512"
										class="form-control " />
								</div>
							</div>
							<div class="form-group">
