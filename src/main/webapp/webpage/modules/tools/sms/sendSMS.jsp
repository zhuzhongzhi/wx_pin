				...
				<div class="mail-box">
					...
					<div class="mail-body">
						<form:form id="inputForm" modelAttribute="mailBox"
							action="${ctx}/tools/sms/send" method="post"
							class="form-horizontal">
							<div class="form-group">
								<label class="col-sm-2 control-label"><font color="red">*</font>发送到：</label>

								<div class="col-sm-8">
									<input type="text" placeholder="输入多个手机号码请用英文符号,隔开" id="tels"
										name="tels" class="form-control" value="">
								</div>
							</div>
