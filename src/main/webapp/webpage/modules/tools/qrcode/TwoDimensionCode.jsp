			...
			<div class="panel-body">
				<form class="form-horizontal">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" id="encoderContent" title="输入内容"
								value="http://www.doforsys.com" class="form-control"> <span
								class="help-block">请输入要生成二维码的字符串</span>
						</div>
						<div class="col-sm-2">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<img id="encoderImgId" cache="false" width="265px"
								height="265px;" class="block" /> <span class="help-block">使用微信扫一扫</span>
						</div>
