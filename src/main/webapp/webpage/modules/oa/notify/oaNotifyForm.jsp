						...
						<form:form id="inputForm" modelAttribute="oaNotify"
							...
							<c:if test="${oaNotify.status ne '1'}">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<sys:userselect id="oaNotifyRecord" name="oaNotifyRecordIds"
								...
								<div class="form-group">
									<table>
										<tr>
											...
											<td class="width-35" colspan="3"><table
													id="contentTable"
													...
													<tbody>
														<c:forEach items="${oaNotify.oaNotifyRecordList}"
															...
															<tr>
																...
																<td><fmt:formatDate
																		value="${oaNotifyRecord.readDate}"
																		pattern="yyyy-MM-dd HH:mm:ss" /></td>
															</tr>
														</c:forEach>
													</tbody>
												</table> 已查阅：${oaNotify.readNum} &nbsp; 未查阅：${oaNotify.unReadNum}
