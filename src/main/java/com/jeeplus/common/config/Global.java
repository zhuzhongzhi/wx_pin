...
public class Global {
	 ...
	 * 是否记录API日志
	 */
	public static Boolean getApiLogEnabled() {
		String dm = getConfig("apiLogEnabled");
	...
	public static Properties getProperties() {
		...
		try {
			InputStream reader = Resources.getResourceAsStream("/properties/jeeplus.properties");
			prop.load(new InputStreamReader(reader, "UTF-8"));
		} catch (Exception e) {
			return null;
		}
		return prop;
