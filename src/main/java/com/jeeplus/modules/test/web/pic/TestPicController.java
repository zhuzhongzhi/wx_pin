...
public class TestPicController extends BaseController {
	...
	public Map<String, Object> data(TestPic testPic, HttpServletRequest request, HttpServletResponse response,
			Model model) {
	 ...
	 * 查看，增加，编辑图片管理表单页面
	 */
	@RequiresPermissions(value = { "test:pic:testPic:view", "test:pic:testPic:add",
			"test:pic:testPic:edit" }, logical = Logical.OR)
