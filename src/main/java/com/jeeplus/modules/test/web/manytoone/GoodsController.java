...
public class GoodsController extends BaseController {
	...
	public Map<String, Object> data(Goods goods, HttpServletRequest request, HttpServletResponse response,
			Model model) {
	 ...
	 * 查看，增加，编辑商品表单页面
	 */
	@RequiresPermissions(value = { "test:manytoone:goods:view", "test:manytoone:goods:add",
			"test:manytoone:goods:edit" }, logical = Logical.OR)
