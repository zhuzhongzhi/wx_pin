...
public class CourseController extends BaseController {
	...
	public Map<String, Object> data(Course course, HttpServletRequest request, HttpServletResponse response,
			Model model) {
	 ...
	 * 查看，增加，编辑课程表单页面
	 */
	@RequiresPermissions(value = { "test:manytomany:course:view", "test:manytomany:course:add",
			"test:manytomany:course:edit" }, logical = Logical.OR)
