...
public class CategoryController extends BaseController {
	 ...
	 * 查看，增加，编辑商品类型表单页面
	 */
	@RequiresPermissions(value = { "test:manytoone:category:view", "test:manytoone:category:add",
			"test:manytoone:category:edit" }, logical = Logical.OR)
	 ...
	 */
	@ResponseBody
	@RequiresPermissions(value = { "test:manytoone:category:add",
			"test:manytoone:category:edit" }, logical = Logical.OR)
