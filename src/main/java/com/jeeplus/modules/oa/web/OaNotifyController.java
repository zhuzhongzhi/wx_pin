...
public class OaNotifyController extends BaseController {
	...
	public Map<String, Object> data(OaNotify oaNotify, boolean isSelf, HttpServletRequest request,
	...
	public String save(OaNotify oaNotify, Model model, RedirectAttributes redirectAttributes) {
		...
		if ("1".equals(oaNotify.getStatus())) {
			...
			for (OaNotifyRecord o : list) {
				...
				new SystemInfoSocketHandler().sendMessageToUser(UserUtils.get(o.getUser().getId()).getLoginName(),
						"收到一条新通知，请到我的通知查看！");
			}
		}
