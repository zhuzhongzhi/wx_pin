...
public class DataRuleController extends BaseController {
	...
	public List<Map<String, Object>> treeData(@RequestParam(required = false) String roleId,
		...
		for (int i = 0; i < list.size(); i++) {
			...
			if (StringUtils.isBlank(extId) || (extId != null && !extId.equals(menu.getId())
					&& menu.getParentIds().indexOf("," + extId + ",") == -1)) {
