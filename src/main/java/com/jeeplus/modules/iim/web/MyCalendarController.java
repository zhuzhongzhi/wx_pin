...
public class MyCalendarController extends BaseController {
	...
	public AjaxJson add(MyCalendar myCalendar, HttpServletRequest request, HttpServletResponse response, Model model) {
	...
	protected List<MyCalendar> doPost(MyCalendar myCalendar, HttpServletRequest request, HttpServletResponse response,
	...
	public AjaxJson save(MyCalendar myCalendar, HttpServletRequest request, HttpServletResponse response, Model model)
			throws Exception {
		AjaxJson j = new AjaxJson();
		myCalendar.setUser(UserUtils.getUser());
	...
	public AjaxJson del(MyCalendar myCalendar, RedirectAttributes redirectAttributes) {
		AjaxJson j = new AjaxJson();
	...
	public AjaxJson resize(MyCalendar myCalendar, HttpServletRequest request, HttpServletResponse response,
			Model model) {
		AjaxJson j = new AjaxJson();
	...
	public AjaxJson drag(MyCalendar myCalendar, HttpServletRequest request, HttpServletResponse response, Model model) {
		AjaxJson j = new AjaxJson();
		Integer daydiff = Integer.parseInt(request.getParameter("daydiff")) * 24 * 60 * 60;
		Integer minudiff = Integer.parseInt(request.getParameter("minudiff")) / 1000;
		Date start = myCalendar.getStart();
