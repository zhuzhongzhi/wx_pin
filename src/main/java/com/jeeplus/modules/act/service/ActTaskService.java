...
public class ActTaskService extends BaseService {
	...
	public List<ProcessInstance> getRunngingProcIns(String procDefKey, User user, int[] pageParams) {
		ProcessInstanceQuery query = runtimeService.createProcessInstanceQuery().processDefinitionKey(procDefKey)
	...
	public List<HistoricProcessInstance> getFinishedProcIns(String procDefKey, User user, int[] pageParams) {
		HistoricProcessInstanceQuery query = historyService.createHistoricProcessInstanceQuery()
				.processDefinitionKey(procDefKey).finished().orderByProcessInstanceEndTime().desc();
	...
	public String queryProcessState(String processInstanceId) throws Exception {
		...
		if (pi != null) {
			// 执行实例
			List<Task> tasks = taskService.createTaskQuery().processInstanceId(pi.getId()).active()
	...
	public InputStream tracePhoto(String processDefinitionId, String executionId) {
		...
		return processDiagramGeneratornew.generateDiagram(bpmnModel, "png", activeActivityIds, highLightedFlows,
				...
				processEngine.getProcessEngineConfiguration().getLabelFontName(), executionId,
