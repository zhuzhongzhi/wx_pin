...
public class ActUserEntityService extends UserEntityManager {
	...
	public long findUserCountByQueryCriteria(UserQueryImpl query) {
		// return (Long) getDbSqlSession().selectOne("selectUserCountByQueryCriteria",
		// query);
		throw new RuntimeException("not implement method.");
	}
	...
	public List<User> findPotentialStarterUsers(String proceDefId) {
		...
		// return (List<User>) getDbSqlSession().selectOne("selectUserByQueryCriteria",
		// parameters);
		throw new RuntimeException("not implement method.");
	...
	public long findUserCountByNativeQuery(Map<String, Object> parameterMap) {
		// return (Long) getDbSqlSession().selectOne("selectUserCountByNativeQuery",
		// parameterMap);
		throw new RuntimeException("not implement method.");
	}
